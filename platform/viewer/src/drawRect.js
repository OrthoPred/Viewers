 ...
 * @returns {undefined}
 */
export default function(context, element, corner1, corner2, options) {
  const cornerstone = window.cornerstone; //external.cornerstone;

  corner1 = cornerstone.pixelToCanvas(element, corner1);
  corner2 = cornerstone.pixelToCanvas(element, corner2);

  // const viewp ort = external.cornerstone.getViewport(element);
